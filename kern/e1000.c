...
e1000_transmit(const char *buf, uint16_t len) {
    // Trunk packet length
    len = len > E1000_BUFFER_SIZE ? E1000_BUFFER_SIZE : len; // TODO: Use MIN
    ...
    return 0; // ToDo: Return the number of bytes sent
}
...
// int
// e1000_timeout_listen(double timeout) { // won't work
